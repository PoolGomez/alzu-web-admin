        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="border-b border-stroke px-4 pb-5 dark:border-strokedark md:px-6 xl:px-7.5">
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:hidden w-6/12 2xsm:w-5/12 md:w-3/12">
                <span className="font-medium">Categoria</span>
              </div>
              {/* <div className="hidden w-4/12 md:block xl:w-3/12">
                <span className="font-medium">Project</span>
              </div> */}
              <div className="hidden w-2/12 xl:block">
                <span className="font-medium">Precio</span>
              </div>
              <div className="hidden w-4/12 2xsm:w-3/12 md:w-2/12 xl:w-2/12">
            ...
            <div className="flex flex-col gap-7">
              {leadsData.map((lead, key) => (
                <div className="flex items-center gap-3" key={key}>
                  ...
                  <div className="hidden sm:hidden w-5/12 2xsm:w-5/12 md:w-3/12">
